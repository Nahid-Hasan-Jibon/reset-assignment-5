...
document.getElementById('donate-btn').addEventListener('click',function(event){
    ...
    const currentDate =currentTimeAndDate.toLocaleDateString(undefined,dateOptions)
...
document.getElementById('donate-btn-2').addEventListener('click',function(event){
    ...
    document.getElementById('current-balance').innerText=updateBalance.toFixed(2)
    const updateDonationBalance= currentDonation+inputValue
    document.getElementById('current-donation-2').innerText=updateDonationBalance.toFixed(2)

    document.getElementById('donate-btn-2').setAttribute("onclick", document.getElementById('my_modal_1').showModal())
...
document.getElementById('donate-btn-3').addEventListener('click',function(event){
    ...
    document.getElementById('current-balance').innerText=updateBalance.toFixed(2)
    const updateDonationBalance= currentDonation+inputValue
    document.getElementById('current-donation-3').innerText=updateDonationBalance.toFixed(2)

    document.getElementById('donate-btn-3').setAttribute("onclick", document.getElementById('my_modal_1').showModal())
